                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-slate-400 text-lg">
                            Providing end-to-end development solutions with a focus on quality, scalability, and modern best practices.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: 'Designing robust and scalable server-side logic, databases, and architecture using Node.js and Express.',
                            icon: Server,
